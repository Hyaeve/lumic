...
.image-load-ring > span { width: 30px; height: 30px; border: 4px solid #ffffff40; border-top-color: #fff; border-right-color: #c3c9ff; border-radius: 50%; animation: image-ring-spin .85s linear infinite; }
